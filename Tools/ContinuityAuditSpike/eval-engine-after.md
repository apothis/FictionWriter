...
|---|---|---|---|
| lighthouse | 81% ±20 | 50% ±28 | 0.57 |
| long_watch | 84% ±17 | 36% ±5 | 0.50 |
| ash_court | 73% ±35 | 28% ±11 | 0.40 |
| tuesday_account | 45% ±5 | 28% ±5 | 0.34 |
| **all** | **71% ±13** | **35% ±9** | **0.45** |

### Reliability — pass@k vs pass^k

- **pass@k** (caught in ≥1 run): 18/40
- **pass^k** (caught in every run): 7/40
...
|---|---|---|
| attribute_drift | 42% | 6/16 |
| knowledge_violation | 8% | 0/4 |
| timeline_conflict | 27% | 0/10 |
| spatial_conflict | 33% | 1/10 |
...
|---|---|---|---|
| lighthouse:c1 | attribute_drift | 2 | 100% |
| lighthouse:c2 | knowledge_violation | 1 | 33% |
| lighthouse:c3 | timeline_conflict | 2 | 67% |
| lighthouse:c4 | spatial_conflict | 5 | 0% |
| long_watch:c1 | attribute_drift | 5 | 100% |
| long_watch:c2 | attribute_drift | 3 | 0% |
| long_watch:c3 | spatial_conflict | 4 | 67% |
...
| ash_court:c4 | attribute_drift | 9 | 33% |
| ash_court:c5 | spatial_conflict | 9 | 0% |
| ash_court:c6 | spatial_conflict | 7 | 67% |
| ash_court:c7 | spatial_conflict | 7 | 33% |
| ash_court:c8 | timeline_conflict | 7 | 67% |
