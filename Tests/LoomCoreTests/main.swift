...
let suites: [TestSuite] = [
    ...
    phase7ServerHealthMonitorTests(),
    phase8SceneExemplarFixtureTests(),
    phase8CosineMatrixTests(),
    phase8EmbedderReportFormatterTests(),
    phase8SpikeOrchestratorTests(),
    phase8BeatPromptStyleExemplarsTests(),
    ...
    phase9ProposedEntitiesStoreTests(),
    phase9SnapshotProposedEntitiesTests(),
    ...
    phase10RelationshipExtractorTests(),
    phase10RelationshipConflictTests(),
    phase10ProposedRelationshipsStoreTests(),
    phase10RelationshipAcceptTests(),
    phase10RelationshipDiscoveryWiringTests(),
    ...
    plannedProjectOutlineSizingTests(),
    plannedProjectStoryFrameworkTests(),
    ...
    plannedProjectKoboldCallProviderTests(),
    plannedProjectStylePromptTests(),
    plannedProjectCreationTests(),
    plannedProjectBridgeIntentTests(),
    plannedProjectAppStateTests(),
    plannedProjectSnapshotTests(),
    plannedProjectStyleEditorTests(),
    plannedProjectStyleEndToEndTests(),
    plannedProjectBeatPlanningTests(),
    plannedProjectBeatPlannerTests(),
    plannedProjectSceneDraftPromptTests(),
    ...
    continuityTypingTests(),
    continuityClaimFilterPipelineTests(),
    helpSystemTests(),
]
