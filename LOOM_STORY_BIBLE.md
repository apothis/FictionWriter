...
- **Negative knowledge isn't auto-extractable** in many cases. "Mia does not know X" requires the prose to explicitly negate, which is rare. Manual authoring of explicit unknowns is the dominant input path; extraction handles assertions.
