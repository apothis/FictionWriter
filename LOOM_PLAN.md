...
| L4 | Generation-mode expansion (Rewrite, Show-don't-tell, Brainstorm, Critique, Bridge); per-mode prompt templates; knowledge-state-per-character extraction | ⏳ next | 4 | [`LOOM_GENERATION_MODES.md`](LOOM_GENERATION_MODES.md), [`LOOM_STORY_BIBLE.md`](LOOM_STORY_BIBLE.md) |
